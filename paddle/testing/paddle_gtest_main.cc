...
int main(int argc, char** argv) {
  ...
  std::vector<paddle_gflags::CommandLineFlagInfo> all_flags;
  std::vector<std::string> external_flags_name;
  paddle_gflags::GetAllFlags(&all_flags);
  ...
  if (paddle_gflags::GetCommandLineOption("max_body_size", &str_max_body_size)) {
  ...
  ::paddle_gflags::ParseCommandLineFlags(&new_argc, &external_argv_address, false);
