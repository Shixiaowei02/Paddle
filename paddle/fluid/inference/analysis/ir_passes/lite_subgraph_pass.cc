...
void OrganizeProgram(Node* merged_node, framework::ProgramDesc* host_program,
  ...
  PADDLE_ENFORCE_EQ(subgraph.empty(), false, platform::errors::NotFound("No subgraph found in lite subgraph pass. Please use the full model call from Analysis Predictor."));
