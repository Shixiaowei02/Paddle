...
class CUDAContext {
 public:
  ...
  const stream::CUDAStream& Stream() const { return stream_; }

  const cudaStream_t& RawStream() const { return stream_.raw_stream(); }
...
class CUDADeviceContext : public DeviceContext {
 public:
  ...
  void AddStreamCallback(Callback&& callback) const {
    return context()->Stream().AddStreamCallback(callback);
  }

  void WaitStreamCallback() const {
    return context()->Stream().WaitStreamCallback();
  }
